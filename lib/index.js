    ...
    */
    ...
    this.setup_x_axis = function (graph){
        ...
        */
        ...
        font_size = "12px"; // set this to 0 if you don't want sample_id as the labels on the x axis
    ...
    this.setup_scatter = function(graph){
        ...
        */
        ...
        .enter() // this will create any new data points for anything that is missing.
            ...
            .style("fill", 
                function (d){
                    temp = d[options.data_column_for_colour];
    ...
    */
    ...
    this.setup_svg = function (graph){
        ...
        svg.append("text")
            ...
            .attr("y", 0 - (page_options.margin.top )/2) 
        ...
        svg.append("text")
            .attr("x", (page_options.width / 2))             
            .attr("y", 0 - (page_options.margin.top / 2)+60)
            .attr("text-anchor", "middle")  
